...
def on_ui_settings():
    ...
    opts.add_option("deforum_allow_blocking_input_framelists", OptionInfo(False, "If a hybrid video input frame is not found, wait for up to 30s for it to appear. This allows hybrid video input frames to be generated by concurrent processes.", gr.Checkbox, {"interactive": True}, section=section))  